...
// Componente principal para el botón y modal de donaciones
export default function DonationButton() {
  // Estado para el modal (cerrado por defecto)
  ...
  // Estado para indicar procesamiento
  ...
  // Maneja el regreso a la selección de método
  const handleBack = () => {
    setStep('select');
    setActiveMethod(null);
  };
  
  // Maneja el cambio en el monto de donación
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Simular procesamiento de pago (en producción, conectar con API real)
      ...
      if (data.success) {
        // Mostrar éxito y avanzar a pantalla de agradecimiento
        setAlertState({
          open: true,
  ...
  // Renderizado condicional de formularios según método seleccionado
  ...
  // Renderiza pantalla de éxito después de la donación
  ...
  // Renderiza la selección de método de pago
